...
class Downtime:
    ...
    def simulate_up(self,*,
        ...
        self.down = False
        engine.resource_manager.available_nodes[:] = [n['id'] for n in engine.resource_manager.nodes if not n['is_down']]
        engine.down_nodes  # Careful! these are the down nodes not managed by the resouce manager but given to the engine!
